...
export const CryptoAIPage = ({ onUpgrade }: { onUpgrade?: () => void }) => {
    ...
    const [jitterValue, setJitterValue] = useState(3500);
    const [isPulsing, setIsPulsing] = useState(false);
    const [logs, setLogs] = useState<string[]>([]);

    // Mock purchased packages - Total: $3500
    const [purchasedPackages] = useState<PurchasedPackage[]>([
        { type: 'VIP', investment: 1000, purchaseDate: '2023-11-20', maturityDate: '2024-11-20' },
        { type: 'Premium', investment: 1000, purchaseDate: '2023-12-15', maturityDate: '2024-12-15' },
        { type: 'Standard', investment: 800, purchaseDate: '2024-01-10', maturityDate: '2025-01-10' },
        { type: 'Basic', investment: 500, purchaseDate: '2024-02-05', maturityDate: '2025-02-05' },
        { type: 'Flexible', investment: 200, purchaseDate: '2024-02-20', maturityDate: '2024-02-20' }
    ]);
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            setJitterValue(3500 + parseFloat(noise));
                      ...
                      <button
                        onClick={() => {
                          if (isAgreeToTerminate) {
                            ...
                            setIsTerminateModalOpen(false);
                            setIsAgreeToTerminate(false);
                            alert('Your engagement has been successfully terminated.');
                          }
                        }}
