...
export const PackageSection = ({ onSelect }: { onSelect: (p: string) => void }) => {
  const packages = [
    ...
    { id: 'standard', name: 'Standard', price: '$500', roi: '108%~', period: '12 Months', color: 'blue', icon: Crown, cnyt: '4%~' },
    { id: 'premium', name: 'Premium', price: '$1,000', roi: '132%~', period: '12 Months', color: 'gold', icon: Zap, popular: true, cnyt: '6%~' },
  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-luxury-gold font-bold tracking-[0.3em] text-sm uppercase mb-3 text-[10px]">Plans</h2>
        <h3 className="text-4xl lg:text-5xl font-serif font-black text-white">LONGRISE Packages</h3>
        ...
        {packages.map((pkg) => (
          ...
          >
            ...
            <div className="space-y-2 lg:space-y-4 mb-4 lg:mb-8">
              ...
              <div className="flex justify-between items-center text-[10px] lg:text-xs">
                <span className="text-gray-400">Annual CNYT</span>
