                                ...
                                >
                                    <div className="bg-black/20 rounded-2xl p-6 border border-[#d4af37]/10 text-center space-y-3">
                                        <p className="text-white/80 text-xs">
                                            Code sent to <span className="text-[#d4af37] font-bold">{email || "your email"}</span>
                                        </p>
                                        <button
                                            type="button"
                                            onClick={() => {
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[10px] text-white/50 ml-2">Demo code: 123456</p>
                                    </div>

                                    <button type="submit" className="w-full h-16 bg-gradient-to-r from-[#ff512f] to-[#fdd835] rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-[0_15px_35px_rgba(255,81,47,0.35)] group mt-10">
                                        <CheckCircle2 size={24} className="text-black" />
                                        <span className="text-black font-black text-xl">Login</span>
                                    </button>
                                </motion.form>
                            ) : signupStep === 1 ? (
                                <motion.form
                        ...
                        <div className="mt-10 pt-8 border-t border-[#d4af37]/20 text-center">
                            <p className="text-sm text-gray-300">
                                {mode === 'login' ? (
                                    ...
                                    <>
                                        Already a VIP member? <button onClick={() => { setMode('login'); setLoginStep(1); setEmail(''); setVerificationCode(''); }} className="text-[#d4af37] font-bold hover:underline transition-all">Access Portfolio</button>
                                    </>
                                )}
                            </p>
                        </div>
