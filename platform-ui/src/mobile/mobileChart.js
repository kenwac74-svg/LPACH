...
(function () {
  var C = {
    ...
    gold: "#38bdf8", goldDim: "#2563eb", grid: "rgba(255,255,255,0.05)",
    text: "#7c726a", ink: "#060d1a"
  };
  ...
  window.LRChart = function (canvas, opts) {
    ...
    function render() {
      ...
      ctx.strokeStyle = "rgba(56,189,248,0.5)"; ctx.setLineDash([4, 4]); ctx.lineWidth = 1;
      ...
      if (opts.ai !== false) {
        ...
        ctx.strokeStyle = "rgba(37,99,235,0.28)"; ctx.lineWidth = 1; ctx.setLineDash([3, 3]);
